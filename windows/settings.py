...
class SettingsWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        layout.addSpacing(8)
        link = QLabel('<a href="https://console.anthropic.com" style="color:#7C6EE0;text-decoration:none;">Get your API key at console.anthropic.com →</a>')
    ...
    def _toggle_edit(self):
        ...
        if self._editing:
            # Don't pre-fill with raw key — force user to type it fresh (security)
    ...
    def save(self):
        ...
        if not self.config.is_valid_key(key):
            self.validation_label.setText("⚠️ Invalid key format — should start with sk-ant-")
        ...
        QTimer.singleShot(1500, lambda: (self.save_btn.setText("Save"), self.apply_styles()))
